...
<body>
    ...
    <?php
        if (isset($_SESSION['username'])) {
            echo '<div class="mt-4 d-flex justify-content-end" style="margin-right: 45px;">
                    <button class="btn btn-success" type="button" data-bs-target="#blog_modal" data-bs-toggle="modal" style="border-radius: 12px; padding-block: 15px;"><ion-icon name="create-outline"></ion-icon> Update </button>
                </div>';
        }
    ?>
    <!-- Profile content -->
